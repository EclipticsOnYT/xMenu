...
namespace xMenuClient
{
    public class VehicleOptions
    {
        ...
        private void CreateMenu()
        {
            ...
            if (IsAllowed(Permission.VONoSiren) && !xMenuShared.ConfigManager.GetSettingsBool(xMenuShared.ConfigManager.Setting.xmenu_use_els_compatibility_mode)) // DISABLE SIREN
            {
