            ...
            playerMenu.OnItemSelect += async (sender, item, index) =>
            {
                ...
                if (item == sendMessage)
                {
                    if (MainMenu.MiscSettingsMenu != null && !MainMenu.MiscSettingsMenu.MiscDisablePrivateMessages)
                    {
                        ...
                        {
                            TriggerServerEvent("xMenu:SendMessageToPlayer", currentPlayer.ServerId, message);
                ...
                else if (item == printIdentifiers)
                {
                    ...
                    BaseScript.TriggerServerEvent("xMenu:GetPlayerIdentifiers", currentPlayer.ServerId, CallbackFunction);
                }
                // kick button
                else if (item == kick)
                {
