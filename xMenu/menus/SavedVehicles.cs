...
namespace xMenuClient
{
    public class SavedVehicles
    {
        ...
        private Dictionary<MenuItem, KeyValuePair<string, VehicleInfo>> sxMenuItems = new Dictionary<MenuItem, KeyValuePair<string, VehicleInfo>>();
        ...
        {
            if (!sxMenuItems.ContainsKey(selectedItem))
            {
            ...
            var vehInfo = sxMenuItems[selectedItem];
        ...
        public void UpdateMenuAvailableCategories()
        {
            ...
            sxMenuItems = new Dictionary<MenuItem, KeyValuePair<string, VehicleInfo>>();
            ...
            foreach (var sv in savedVehicles)
            {
                if (IsModelInCdimage(sv.Value.model))
                {
                    ...
                    sxMenuItems.Add(savedVehicleBtn, sv);
                }
                else
                {
