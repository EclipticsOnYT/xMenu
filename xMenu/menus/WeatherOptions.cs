...
namespace xMenuClient
{
    public class WeatherOptions
    {
        ...
        private void CreateMenu()
        {
            ...
            snowEnabled = new MenuCheckboxItem("Enable Snow Effects", "This will force snow to appear on the ground and enable snow particle effects for peds and vehicles. Combine with X-MAS or Light Snow weather for best results.", ConfigManager.GetSettingsBool(ConfigManager.Setting.xmenu_enable_snow));
