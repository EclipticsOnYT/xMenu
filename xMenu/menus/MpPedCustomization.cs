...
using static xMenuClient.MpPedDataManager;
...
namespace xMenuClient
{
    public class MpPedCustomization
    {
        ...
        public Menu savedCharactersMenu = new Menu("xMenu", "Manage Saved Characters");
        public Menu inheritanceMenu = new Menu("xMenu", "Character Inheritance Options");
        public Menu appearanceMenu = new Menu("xMenu", "Character Appearance Options");
        public Menu faceShapeMenu = new Menu("xMenu", "Character Face Shape Options");
        public Menu tattoosMenu = new Menu("xMenu", "Character Tattoo Options");
        public Menu clothesMenu = new Menu("xMenu", "Character Clothing Options");
        public Menu propsMenu = new Menu("xMenu", "Character Props Options");
        private Menu manageSavedCharacterMenu = new Menu("xMenu", "Manage MP Character");
        ...
        private void CreateMenu()
        {
            ...
            */
            ...
            createCharacterMenu.OnItemSelect += async (sender, item, index) =>
            {
                ...
                {
                    bool confirm = false;
                    AddTextEntry("xmenu_warning_message_first_line", "Are you sure you want to exit the character creator?");
                    AddTextEntry("xmenu_warning_message_second_line", "You will lose all (unsaved) customization!");
                    ...
                    while (true)
                    {
                        ...
                        int unk = 1;
                        int unk2 = 1;
                        SetWarningMessage("xmenu_warning_message_first_line", 20, "xmenu_warning_message_second_line", true, 0, ref unk, ref unk2, true, 0);
            ...
            menu.OnItemSelect += async (sender, item, index) =>
            {
                if (item == createMaleBtn)
                {
                    ...
                    await SpawnWeaponLoadoutAsync("xmenu_temp_weapons_loadout_before_respawn", false, true, true);
        ...
        private void CreateSavedPedsMenu()
        {
            ...
            manageSavedCharacterMenu.OnItemSelect += async (sender, item, index) =>
            {
                ...
                else if (item == setAsDefaultPed)
                {
                    ...
                    SetResourceKvp("xmenu_default_character", "mp_ped_" + selectedSavedCharacterManageName);
                }
        ...
        {
            string defaultChar = GetResourceKvpString("xmenu_default_character") ?? "";
